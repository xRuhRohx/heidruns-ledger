import { Component, inject, signal, OnInit } from '@angular/core';
  ...
  import { formatDateTime, formatDateOnly } from '../../../core/utils/date';

  @Component({
    selector: 'app-batch-detail',
    imports: [RouterLink, FormsModule, NgClass, GravityChartComponent],
  ...
  export class BatchDetail implements OnInit {
    ...
    ngOnInit() {
      ...
      this.batchService.getNotes(id).subscribe(notes => this.notes.set(notes));
      this.batchService.getIngredients(id).subscribe(ingredients => this.ingredients.set(ingredients));
